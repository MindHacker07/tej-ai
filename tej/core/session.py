...
@dataclass
class SessionState:
    """Represents the state of a TejStrike AI session."""
    session_id: str
    started_at: str
...
class SessionManager:
    """
    Manages TejStrike AI sessions - tracks targets, findings, tool usage,
    ...
    def generate_report(self) -> str:
        ...
        report = []
        report.append("=" * 70)
        report.append("TEJSTRIKE AI - SECURITY ASSESSMENT REPORT")
        report.append("=" * 70)
        ...
        report.append("=" * 70)
        report.append("End of Report - Generated by TejStrike AI")
        report.append("=" * 70)
